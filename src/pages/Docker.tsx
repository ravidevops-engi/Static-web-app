...
import { Container, ChevronDown, Bookmark } from "lucide-react";
import { dockerSections } from "@/data/dockerData";
...
export default function Docker() {
  ...
  const {
    ...
    toggleBookmark,
    isBookmarked,
  } = useQuestionProgress("docker");

  const totalQuestions = dockerSections.reduce(
  ...
  return (
    <div className="container max-w-4xl px-4 py-12">
      ...
      <div className="mb-12 flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-500 shadow-glow">
          <Container className="h-8 w-8 text-white" />
        </div>
        <div>
          <h1 className="text-4xl font-bold">Docker & Containerization</h1>
          <p className="text-lg text-muted-foreground">
            Containerization, Images, Networking & Docker Compose
          </p>
        </div>
      </div>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <p className="text-lg mb-8">
          Comprehensive Docker interview preparation covering container
          fundamentals, commands, images, volumes, networking, and Compose.
        </p>
              ...
              <AccordionContent>
                <div className="space-y-4 mt-4">
                  {section.questions.map((item, qIndex) => {
                    ...
                    // detect both plain & html answers
                    ...
                    const answerText = hasPlainAnswer
                      ? (item as any).answer
                      : null;
