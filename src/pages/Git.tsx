...
import { GitBranch, ChevronDown, Bookmark } from "lucide-react";
import { gitSections } from "@/data/gitData";
...
export default function Git() {
  ...
  const {
    ...
    toggleBookmark,
    isBookmarked,
  } = useQuestionProgress("git");

  const totalQuestions = gitSections.reduce(
  ...
  return (
    <div className="container max-w-4xl px-4 py-12">
      ...
      <div className="mb-12 flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 shadow-glow">
          <GitBranch className="h-8 w-8 text-white" />
        </div>
        <div>
          <h1 className="text-4xl font-bold">Git & Version Control</h1>
          <p className="text-lg text-muted-foreground">
            Git, Azure Repos, GitHub Actions & Branching Strategies
          </p>
        </div>
      </div>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <p className="text-lg mb-8">
          Master version control with Git, Azure Repos integration, and GitHub
          Actions workflows.
        </p>
                ...
                <div className="space-y-4 mt-4">
                  {section.questions.map((item, qIndex) => {
                    ...
                    return (
                      <div
                        key={qIndex}
                        className="border-l-2 border-orange-500/30 pl-4 py-2"
                      >
