...
import { Boxes, ChevronDown, Bookmark } from "lucide-react";
import { miscellaneousSections } from "@/data/miscellaneousData";
...
export default function Miscellaneous() {
  ...
  const {
    ...
    toggleBookmark,
    isBookmarked,
  } = useQuestionProgress("miscellaneous");

  const totalQuestions = miscellaneousSections.reduce(
  ...
  return (
    <div className="container max-w-4xl px-4 py-12">
      ...
      <div className="mb-12 flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 shadow-glow">
          <Boxes className="h-8 w-8 text-white" />
        </div>
        <div>
          <h1 className="text-4xl font-bold">Miscellaneous Topics</h1>
          <p className="text-lg text-muted-foreground">
            Cloud Fundamentals, IaC, CI/CD, DevSecOps & Architecture
          </p>
        </div>
      </div>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <p className="text-lg mb-8">
          Explore various DevOps concepts including cloud fundamentals,
                ...
                <div className="space-y-4 mt-4">
                  {section.questions.map((item, qIndex) => {
                    ...
                    return (
                      <div
                        key={qIndex}
                        className="border-l-2 border-amber-500/30 pl-4 py-2"
                      >
